...
uint8_t PACK_buff[32];
	...
	if (mpu_read_fifo_stream(dmp.packet_length, PACK_buff, more))
			return 1;
	else{
		/*	读取四元数数据	*/
...
////////////////////////////    /* Get a packet. */
////////////////////////////    if (error=mpu_read_fifo_stream(dmp.packet_length, PACK_buff, more),error)
//////////////////////////////			LCD_ShowNum(30,300,error,32,16);
////////////////////////////        return 1;
...
////////////////////////////        accel[0] = ((short)PACK_buff[ii+0] << 8) | PACK_buff[ii+1];
////////////////////////////        accel[1] = ((short)PACK_buff[ii+2] << 8) | PACK_buff[ii+3];
////////////////////////////        accel[2] = ((short)PACK_buff[ii+4] << 8) | PACK_buff[ii+5];
////////////////////////////        ii += 6;
////////////////////////////        sensors[0] |= INV_XYZ_ACCEL;
//////////////////////////////    }

//////////////////////////////    if (dmp.feature_mask & DMP_FEATURE_SEND_ANY_GYRO) {
////////////////////////////        gyro[0] = ((short)PACK_buff[ii+0] << 8) | PACK_buff[ii+1];
////////////////////////////        gyro[1] = ((short)PACK_buff[ii+2] << 8) | PACK_buff[ii+3];
////////////////////////////        gyro[2] = ((short)PACK_buff[ii+4] << 8) | PACK_buff[ii+5];
////////////////////////////        ii += 6;
////////////////////////////        sensors[0] |= INV_XYZ_GYRO;
//////////////////////////////    }
